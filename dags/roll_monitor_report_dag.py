...
with DAG(
    dag_id="roll_monitor_expo_report",
    default_args=DEFAULT_ARGS,
    description="Envia relatorio de alterações do Roll Monitor Expo",
    schedule="30 11 * * 1-5",
    ...
    send_report = DockerOperator(
        task_id="send_report",
        image="ticeslogistics/roll_monitor_expo:latest",
        force_pull=True,
        api_version="auto",
        auto_remove="force",
        docker_url="unix://var/run/docker.sock",
        network_mode="bridge",
        command=["python", "src/main.py", "send-report"],
